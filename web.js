...
var $;
(function ($) {
    class $team extends $mol_page {
        title() {
            return "Fishing (scam) chat";
        }
        plugins() {
            return [
                this.Theme(),
        ...
        Message(id) {
            const obj = new this.$.$team_positioned_view();
            obj.minimal_height = () => 80;
            obj.is_operator = () => this.is_operator(id);
            obj.sub = () => [
                this.Message_card(id)
            ];
            return obj;
        }
        Theme() {
        ...
        Draft_send() {
            ...
            obj.title = () => this.$.$mol_locale.text('$team_Draft_send_title');
            obj.hint = () => this.$.$mol_locale.text('$team_Draft_send_hint');
            obj.sub = () => [
    ...
    __decorate([
        $mol_mem_key
    ], $team.prototype, "Message", null);
    __decorate([
        $mol_mem
    ], $team.prototype, "Theme", null);
    __decorate([
        $mol_mem
    ], $team.prototype, "draft_send", null);
    __decorate([
        $mol_mem
    ], $team.prototype, "Send_key", null);
    __decorate([
        $mol_mem
    ], $team.prototype, "Lighter", null);
    __decorate([
        $mol_mem
    ], $team.prototype, "content", null);
    __decorate([
        $mol_mem
    ], $team.prototype, "draft_text", null);
    __decorate([
        $mol_mem
    ], $team.prototype, "Draft_text", null);
    __decorate([
        $mol_mem
    ], $team.prototype, "Speech_toggle_icon", null);
    __decorate([
        $mol_mem
    ], $team.prototype, "hearing", null);
    __decorate([
        $mol_mem
    ], $team.prototype, "Speech_toggle", null);
    __decorate([
        $mol_mem
    ], $team.prototype, "Draft_send_icon", null);
    __decorate([
        $mol_mem
    ], $team.prototype, "Draft_send", null);
    __decorate([
    ...
    class $team_positioned_view extends $mol_view {
        ...
        attr() {
            return {
                ...super.attr(),
                team_positioned_message: this.is_operator()
            };
        }
    }
    $.$team_positioned_view = $team_positioned_view;
})($ || ($ = {}));
//team/-view.tree/view.tree.ts
;
"use strict";
var $;
(function ($) {
...
(function ($) {
    ...
    (function ($$) {
        class $team extends $.$team {
            ...
            messages() {
                return this.text_messages().map((data) => this.Message(data));
            }
            text_messages(next) {
                return next || [];
            }
        ...
        __decorate([
            $mol_mem
        ], $team.prototype, "speech_to_text", null);
        __decorate([
            $mol_mem
        ...
        __decorate([
            $mol_mem
        ], $team.prototype, "text_messages", null);
        __decorate([
            $mol_mem
        ], $team.prototype, "message_text", null);
        __decorate([
            $mol_mem
