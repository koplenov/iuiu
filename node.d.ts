...
declare namespace $ {
    class $team extends $mol_page {
        ...
        body(): readonly any[];
        foot(): readonly any[];
        Message(id: any): $team_positioned_view;
        ...
        is_operator(id: any): any;
        message_text(id: any): string;
        Message_card(id: any): $$.$mol_card;
    }
    class $team_positioned_view extends $mol_view {
        is_operator(): any;
        attr(): {
            team_positioned_message: any;
        };
    }
}
...
declare namespace $.$$ {
    class $team extends $.$team {
        ...
        draft_send(): void;
        messages(): $mol_view[];
        text_messages(next?: any[]): any[];
        message_text(data: any): any;
        is_operator(data: any): any;
    }
}
